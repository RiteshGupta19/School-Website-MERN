...
export default function Birth() {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      try {
        const response = await fetch('http://localhost:5000/api/admin/gallary/birth anniversary');
  ...
  return (
    <div>
      <Header/>
      <div className='text-[30px] font-bold text-center mt-5'>BIRTH ANNIVERSARY</div>

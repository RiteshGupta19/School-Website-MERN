...
export default function Science() {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      try {
        const response = await fetch('http://localhost:5000/api/admin/gallary/science exhibition');
  ...
  return (
    <div>
      <Header/>
      <div className='text-[30px] font-bold text-center mt-5'>SCIENCE EXHIBITION</div>

...
export default function Krishna() {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      try {
        const response = await fetch('http://localhost:5000/api/admin/gallary/radha krishna competition');
  ...
  return (
    <div>
      <Header/>
      <div className='text-[30px] font-bold text-center mt-5'>RADHA KRISHNA COMPETATION</div>

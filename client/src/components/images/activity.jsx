...
export default function Activity() {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      try {
        const response = await fetch('http://localhost:5000/api/admin/gallary/school activities');
  ...
  return (
    <div>
      <Header/>
      <div className='text-[30px] font-bold text-center mt-5'>SCHOOL ACTIVITY</div>
